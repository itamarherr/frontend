...
const Footer = () => {
  ...
  className="p-8 flex flex-col md:flex-row items-center justify-between gap-6 bg-fuchsia-50 text-fuchsia-900 dark:bg-green-800 dark:text-green-100"
    ...
    >
      ...
      <p className="text-lg mt-2">Phone: <a href="tel:+972 523278700" className="text-blue-500 hover:underline">+972 523278700</a></p>
      <p className="text-lg mt-2">Email: <a href="maito:itamarherr@gmail.com" className="text-blue-500 hover:underline">itamarherr@gmail.com</a></p>
      </div>
